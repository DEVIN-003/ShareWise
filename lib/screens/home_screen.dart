...
import '../screens/final_display.dart';
import '../services/firestore_services.dart';
import '../auth/login_screen.dart'; // Ensure the correct import path
                    ...
                    child: ListTile(
                      ...
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => FinalDisplay(subjectName: filteredSubjects[index]["id"]!),
                          ),
                        );
                      },
                    ),
